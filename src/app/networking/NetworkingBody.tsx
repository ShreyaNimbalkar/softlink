  ...
  >
    ...
    Download Quotation
          ...
          {/* <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="relative mt-24 overflow-hidden rounded-[40px] border border-[#33CCCC]/20 bg-gradient-to-br from-[#33CCCC] to-[#29B3B3] p-8 sm:p-10 lg:p-14 shadow-2xl shadow-[#33CCCC]/20"
          > */}
            {/* BACKGROUND GLOW */}
            ...
            <div className="relative z-10 grid gap-10 lg:grid-cols-2 lg:items-center"> */}
              ...
              {/* <div>
                ...
                <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/80">
                  Get detailed information about our networking,
                  surveillance, server infrastructure, hardware,
                  and enterprise IT service offerings.
                </p> */}
              ...
              {/* <div className="flex flex-col items-start lg:items-end">
                <div className="w-full max-w-md rounded-[32px] border border-white/20 bg-white/10 p-8 backdrop-blur-xl">
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-white/70">
                        Updated company service portfolio
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="mt-5 text-center text-sm text-white/60">
                    PDF • Company Brochure • Service Details
                  </p>
                </div>
              </div>
            </div>
