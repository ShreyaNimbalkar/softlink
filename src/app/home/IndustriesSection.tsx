        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20">
          {industries.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{y: -8,}}
              className="group relative overflow-hidden rounded-[32px] border border-slate-200 dark:border-white/10 bg-white/70 dark:bg-white/5 backdrop-blur-xl p-10 shadow-sm hover:border-[#33CCCC]/30 hover:shadow-2xl hover:shadow-[#33CCCC]/10 transition-all duration-500">
              {/* HOVER GLOW */}
              ...
              {/* ICON */}
              <div className="relative w-16 h-16 rounded-2xl bg-[#33CCCC]/10 text-[#33CCCC] flex items-center justify-center text-2xl border border-[#33CCCC]/10 group-hover:scale-110 transition-transform duration-500">
