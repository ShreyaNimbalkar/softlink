        ...
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-8 max-w-2xl text-lg leading-relaxed text-slate-300">
              ...
              using our website, products, and technology services.
              These terms outline the rules, responsibilities, and
              policies governing our business relationship.
            </p>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-slate-400">
                        Clear and transparent terms for all business
                ...
                {/* <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-6">
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-slate-400">
                        Responsible usage guidelines designed to
